...
def create_param_str(args, sep='_', object='synthetic', key=0):
	if object == 'synthetic':
		...
		arg_groups = ['dataset', 'dataset_train', 'train', 'gnn', 'random_forest', 'pretrain', 'embedding', 'spectral_embedding',  'deepwalk', 'gosh', 'pfr', 'edits', 'invert', 'dw_backwards', 'adjacency_similarity', 'intrain', 'nifty', 'posttrain','blackbox']
